...
class MainFragment : Fragment() {
    ...
    private val exitActionIds = listOf(
            R.id.action_next_to_first_activity,
            R.id.action_next_to_second_activity
    )
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        btnToFirstGraphExample.setOnClickListener {
            navController.navigate(MainFragmentDirections.actionNextToFirstActivity(), exitActionIds, requireActivity())
        }
